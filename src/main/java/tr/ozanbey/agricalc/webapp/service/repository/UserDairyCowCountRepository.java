...
import tr.ozanbey.agricalc.webapp.webapp.view.DairyCowResultCountView;
...
public interface UserDairyCowCountRepository extends JpaRepository<UserDairyCowCount, Long> {
    ...
    @Query("""
            SELECT new tr.ozanbey.agricalc.webapp.webapp.view.DairyCowCountView(
    ...
    @Query("""
            SELECT new tr.ozanbey.agricalc.webapp.webapp.view.DairyCowResultCountView(
