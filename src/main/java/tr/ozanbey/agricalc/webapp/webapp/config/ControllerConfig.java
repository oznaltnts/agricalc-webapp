...
public class ControllerConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/public/financial-literacy").setViewName("forward:/public/financial-literacy.xhtml");
        ...
        registry.addViewController("/secured/admin/plantation/coefficient").setViewName("forward:/secured/admin/plantation/coefficient.xhtml");
        registry.addViewController("/secured/admin/plantation/disease").setViewName("forward:/secured/admin/plantation/disease.xhtml");
